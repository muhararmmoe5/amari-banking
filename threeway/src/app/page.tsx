...
type Result =
  | { conference: string; sids: Record<string, string> }
  | { error: string };
    ...
    <main className="min-h-screen px-6 py-10">
      <div className="max-w-md mx-auto">
        ...
        <form onSubmit={start} className="space-y-4">
          <Field label="Your number" value={initiator} onChange={setInitiator} />
          <Field label="Party A" value={partyA} onChange={setPartyA} />
          <Field label="Party B" value={partyB} onChange={setPartyB} />
